...
{-| TypeAliasDef (AliasRecordType (TypeName "Protocol.Alert" []) [CustomField (FieldName "title") (CustomTypeConstructor (TitleCaseDotPhrase "String") []),CustomField (FieldName "body") (CustomTypeConstructor (TitleCaseDotPhrase "String") [])]) -}
encodeProtocolAlert : Protocol.Alert -> Json.Encode.Value
encodeProtocolAlert value =
    Json.Encode.object
...
{-| TypeAliasDef (AliasRecordType (TypeName "Protocol.Alert" []) [CustomField (FieldName "title") (CustomTypeConstructor (TitleCaseDotPhrase "String") []),CustomField (FieldName "body") (CustomTypeConstructor (TitleCaseDotPhrase "String") [])]) -}
decodeProtocolAlert : Json.Decode.Decoder (Protocol.Alert)
decodeProtocolAlert  =
    Json.Decode.succeed Protocol.Alert
