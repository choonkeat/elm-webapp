...
<details><summary>sequence diagram markup</summary>
<pre>
sequenceDiagram
    note left of Client.elm: type MsgFromClient = Hello String | Goodbye
    Client.elm->>+Server.elm: sendToServer (Hello "Bob") : Cmd msg
    Server.elm-->>-Client.elm: Task.succeed (Greet "Hi, Bob")
    note right of Server.elm: type MsgFromServer = Greet String | Farewell
    Client.elm->>+Server.elm: sendToServer Goodbye : Cmd msg
    Server.elm-->>-Client.elm: Task.succeed Farewell
</pre>
</details>
